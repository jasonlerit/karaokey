...
Exercise guest flows at 320×568, 390×844, and 412×915 CSS pixels. Exercise host flows at 960×540
(the validated TV browser CSS viewport), 1024×576, 1280×720, 1920×1080, and one stacked/narrow
viewport. At each size, create/join a room, search, add/remove a request,
start/pause/restart/skip playback, reconnect, handle an unavailable video, and end the room.
